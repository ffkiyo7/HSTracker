...
| Phase 2 | 记牌器分区（牌库 / 手牌 / 已打出） | 🎮 T1 代码完成 + review 通过（2026-09-13，`docs/tasks/phase2-t1-zone-groups.md`）：三段之和恒等于已知张数（8 条测试），`highlightCardsInHand` / `removeCardsFromDeck` 在分区模式下不参与，已打出段暂用暗条 · 待实战 ×4。之后 2.6 / 2.7 / 2.8 未动 |
