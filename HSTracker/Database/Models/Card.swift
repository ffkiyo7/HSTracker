...
final class Card {
    ...
    var isBaconDuosExclusive = 0
    var isBaconPoolSpell = false
    var deckListIndex = 0
...
extension Card: NSCopying {
    ...
    func copy(with zone: NSZone? = nil) -> Any {
        ...
        copy.isBaconPoolMinion = self.isBaconPoolMinion
        ...
        copy.isBaconPoolSpell = self.isBaconPoolSpell
        copy.isBaconDuosExclusive = self.isBaconDuosExclusive
